...
exports.DumpXVIZ = exports.DumpMode = void 0;

var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));

var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));

var DumpMode = Object.freeze({
  ONELINE: 0,
  CONDENSED: 1,
  ALL: 2
});
...
var DumpXVIZ = function () {
  function DumpXVIZ() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    (0, _classCallCheck2["default"])(this, DumpXVIZ);
    this.mode = options.mode === undefined ? DumpMode.ALL : options.mode;
    this.log = options.log || console.log;
  }

  (0, _createClass2["default"])(DumpXVIZ, [{
    key: "onConnect",
