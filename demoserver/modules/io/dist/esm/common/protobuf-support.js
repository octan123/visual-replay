...
export var XVIZ_PROTOBUF_MESSAGE_NAME = {
...
export var XVIZ_PROTOBUF_TYPE_NAME = {
  UI_PANEL_INFO: 'xviz.v2.UIPanelInfo'
};
export var MAGIC_PBE1 = 0x50424531;
export var XVIZ_PROTOBUF_MAGIC = Uint8Array.from([0x50, 0x42, 0x45, 0x31]);
export var XVIZ_PROTOBUF_ROOT = loadProtos();
export var XVIZ_PROTOBUF_MESSAGE = {
