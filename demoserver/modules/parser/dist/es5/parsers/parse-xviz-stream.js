...
function parseStreamPrimitive(primitives, streamName, time, convertPrimitive) {
  ...
  for (var objectIndex = 0; objectIndex < objects.length; objectIndex++) {
    ...
    if (object && Array.isArray(object)) {
      ...
      var _primitive = (0, _parseXvizPrimitive.normalizeXVIZPrimitive)(PRIMITIVE_SETTINGS, object, objectIndex, streamName, primType, time, convertPrimitive);
      ...
      if (_primitive) {
        ...
        if (_globals.isMainThread && (streamName === OBJECT_STREAM || !OBJECT_STREAM && _primitive.id && category === 'features')) {
...
function parseStreamTimeSeriesV2(seriesArray, streamBlackList) {
  ...
  var _getXVIZConfig5 = (0, _xvizConfig.getXVIZConfig)(),
