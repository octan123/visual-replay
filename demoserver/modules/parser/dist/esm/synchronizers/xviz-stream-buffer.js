...
var RIGHT = INSERT_POSITION.RIGHT;
var UNLIMITED = 0;
var OFFSET = 1;
var FIXED = 2;
...
var XVIZStreamBuffer = function () {
  ...
  _createClass(XVIZStreamBuffer, [{
    ...
    value: function getTimeslices() {
      ...
      var persistentEndIndex = Number.isFinite(end) ? findInsertPos(persistent, end, RIGHT) : persistent.length;
    ...
    value: function _insertPersistentSlice(persistentSlice) {
      ...
      var index = findInsertPos(persistent, timestamp, LEFT);
