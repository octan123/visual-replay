...
exports.ROS2XVIZConverter = void 0;
...
var ROS2XVIZConverter = function () {
  function ROS2XVIZConverter(converters, rosConfig) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    (0, _classCallCheck2["default"])(this, ROS2XVIZConverter);
  ...
  (0, _createClass2["default"])(ROS2XVIZConverter, [{
    key: "verbose",
    ...
    key: "buildMessage",
    value: function () {
      var _buildMessage = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(frame) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                xvizBuilder = new _builder.XVIZBuilder(this.metadata, this.disableStreams, {});
...
exports.ROS2XVIZConverter = ROS2XVIZConverter;
