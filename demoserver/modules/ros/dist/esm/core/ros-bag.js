...
export var ROSBag = function () {
  function ROSBag(bagPath, rosConfig) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    _classCallCheck(this, ROSBag);
  ...
  _createClass(ROSBag, [{
    key: "init",
    value: function () {
      var _init = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(ros2xviz) {
        var bag;
    ...
    key: "_openBag",
    value: function () {
      var _openBag2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2() {
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return open(this.bagPath);
    ...
    key: "_initBag",
    value: function () {
      var _initBag2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee3(bag) {
    ...
    key: "readMessages",
    value: function () {
      var _readMessages = _asyncToGenerator(_regeneratorRuntime.mark(function _callee5(start, end) {
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                return bag.readMessages(options, function () {
                  var _ref2 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(result) {
