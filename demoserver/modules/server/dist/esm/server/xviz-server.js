...
export var XVIZServer = function () {
  function XVIZServer(handlers, options, callback) {
    var _this = this;

    _classCallCheck(this, XVIZServer);
  ...
  _createClass(XVIZServer, [{
    ...
    key: "handleSession",
    value: function () {
      var _handleSession = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(socket, request) {
